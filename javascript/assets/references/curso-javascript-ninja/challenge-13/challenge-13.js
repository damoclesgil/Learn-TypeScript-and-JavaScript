(function () {
  ...
  */
  ...
  sudeste = ['Espírito Santo', 'Minas Gerias', 'Rio de Janeiro', 'São Paulo'];
  ...
  */
  var nordeste = ['Alagoas', 'Bahia', 'Ceará', 'Maranhão', 'Paraíba', 'Pernamubco', 'Piauí', 'Rio Grande do Norte', 'Sergipe']
  ...
  */
  ...
  chamada `newSudeste`.
  */
  var newSudeste = brasil.splice(5, 4); // A partir do quinto vou remover 4 
  /*
