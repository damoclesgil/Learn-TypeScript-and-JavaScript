...
*/
const arrei = [true, 21, 'Dâmocles', function () { }, { curso: 'Javascript N1nj4' }];
// arrei.length
/*
...
*/
console.log('O segundo elemento do segundo array é ' + arrei[1] + '.');
...
"O segundo array tem [QUANTIDADE DE ITE
    NS] itens."
*/
console.log('O segundo array tem ' + arrei[5].length + ' itens')
